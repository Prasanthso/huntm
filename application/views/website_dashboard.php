    ...
    <div class="main-container">
        ...
        <div id="sidebar" class="border-end">
            <div class="list-group list-group-flush">
                ...
                <a class="dropdown-item fileupload list-group-item list-group-item-action w-100" href="<?php echo base_url('customer_strength'); ?>">Customer Strength</a>
